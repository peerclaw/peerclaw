...
> If you're using a deployed public service (e.g., `https://peerclaw.io`), you can skip this step.
...
| Register Agent (beginners) | Console → Generate Token → Copy prompt to Agent |
